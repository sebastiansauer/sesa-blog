...
[Hier](http://rolandtanglao.com/2018/10/01/p1-directlabels-in-r-labels-at-the-end-of-lines/) gibt es noch ein interessantes Paket, um Liniendiagramme mit Labels zu versehen.
...
Wär es jetzt nicht allerhöchste Zeit,
...
```{r echo = FALSE}
knitr::include_graphics("https://de.wikipedia.org/wiki/Scheinkorrelation#/media/Datei:Scheinkorrelation_Storchenpopulation_Geburtenzahl.jpg")
```
...
Zum Glück gibt es auch viele gute Berichtserstattung, z.B. - eine Replik auf einen Fall ähnlich gelagert zu dem gerade Beschriebenen - [hier](https://www.tagesschau.de/faktenfinder/impfquote-uebersterblichkeit-101.html).
