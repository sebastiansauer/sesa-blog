...
*Nur zur Demonstration, nicht inhaltlich wichtig*
...
Dazu muss die Variable aber als `factor` vorliegen.
...
(Nur) Mit einer sortierten Faktorvariable lässt sich ein gut sortiert darstellen.
