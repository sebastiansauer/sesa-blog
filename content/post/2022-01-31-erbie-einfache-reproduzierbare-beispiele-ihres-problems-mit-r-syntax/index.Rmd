...
würde, das Problem exakt zu beschreiben und alles "reproduzierbar" zu gesalten,
...
Problem löst, sollten Sie folgende Eckpunkte beachten.
...
- *Schon probiert*: Geben Sie an, was Sie selber versucht haben, um das Problem zu lösen und was dabei herausgekommen ist.
- *Syntax*: Stellen Sie die Syntax, die das Problem erzeugt, in *Textform* bereit, nicht als Screenshot. Sonst muss Ihre Hilferin die Syntax abtippen.
