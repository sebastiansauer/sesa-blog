...
For example, let's assume for simplicity $n=3, o=10$. Then we have
...
In total, $Pr = Pr_1 \cdot Pr_2 \cdot Pr_3$.
...
Unfortunately, I have not yet found the right analytical solution.
