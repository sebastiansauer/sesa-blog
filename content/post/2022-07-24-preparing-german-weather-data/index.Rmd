...
```{r}
write_csv(d_precip_temp, file = "/Users/sebastiansaueruser/github-repos/datasets/csv/precip_temp.csv")

save(d_precip3, file = "/Users/sebastiansaueruser/github-repos/datasets/Rdata/precip_temp.Rdata")
```
