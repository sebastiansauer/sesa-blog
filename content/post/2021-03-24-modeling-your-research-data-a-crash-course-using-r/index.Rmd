...
For example, statistical inference -- such as p-values and confidence intervals -- are not more than briefly touched, as the instructor believes that modeling, not inference, is of prime importance for the auditorium.
