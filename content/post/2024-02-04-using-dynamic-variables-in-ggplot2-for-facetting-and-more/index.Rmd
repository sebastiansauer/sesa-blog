...
With `sym` you can capture the "symbol", i.e. the code, of an expression such as a string. In the second step, evaluate it using bang-bang (`!!`). If it's more than one variable, use the triple-bang operator, `!!!`.
